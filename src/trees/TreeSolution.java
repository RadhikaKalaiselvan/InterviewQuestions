...
class TreeSolution {
	  ...
	  static class BinarySearchTree {
	    ...
	    Node result=findSmallestOnRightTree(inputNode.right);
	    System.out.println("First return "+result);
	    if(result==null){
	    	result=findFirstGreatestParent(inputNode);
	   // 	System.out.println("Second return "+result.key);
	    }
	    return result;
	    }
	    
	    private Node findFirstGreatestParent(Node inputNode) {
		...
		private Node findSmallestOnRightTree(Node n) {
			// TODO Auto-generated method stub
		//	System.out.println("right tree"+n.key);
